...
class PabellonList extends Component {
    ...
    return (
      <Container fluid className="main-content-container px-4">
        ...
        <Row noGutters className="page-header py-4">
          <PageTitle sm="4" title="Lista de Pabellones" subtitle="" className="text-sm-left" />
          (Si el Id del Paciente es 0, significa que el pabellon se encuentra disponible y no se ha asignado aun)
        </Row>
              ...
              <Col lg="2" key={pabellon.id}>
                <Card small className="card-post mb-4">
                  <CardBody>
                    ...
                    <p className="card-text text-muted">Id Paciente Asignado: {pabellon.paciente}</p>
                    <p className="card-text text-muted">Equipamiento: {pabellon.equipamiento}</p>
                    <p className="card-text text-muted">Hora Ingreso: {pabellon.hora}</p>
